...
text_file = spark.read.text("/databricks-datasets/samples/docs/README.md")
...
data.cache() # cash data for faster use 
...
# MAGIC %sql
# MAGIC select City , `2014 Population estimate` from data_geo
# MAGIC where `State Code` = 'WA';

# COMMAND ----------

# MAGIC %sql
# MAGIC select `State Code` , sum(`2015 median sales price`) from data_geo
# MAGIC group by `State Code`

# COMMAND ----------

# MAGIC %sql
# MAGIC select City,`2014 Population estimate`/1000
# MAGIC from data_geo
